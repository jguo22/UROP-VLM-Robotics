"""
Shared Constants for Unity-ROS Communication

This module defines common protocol constants, default values, and configuration
parameters used across the Python clients (IK server, OpenVLA client, etc.).
"""
